...
import thehogmod.potions.BasePotion;
import thehogmod.relics.BaseRelic;
import thehogmod.savables.BonusCardRewardSavable;
import thehogmod.util.GeneralUtils;
import thehogmod.util.KeywordInfo;
...
@SpireInitializer
public class TheHogMod implements
    ...
    public void receivePostInitialize() {
        ...
        registerPotions();
        BaseMod.addSaveField(makeID("BonusCardReward"), new BonusCardRewardSavable());
    }
    ...
    private static String checkResourcesPath() {
        String name = TheHogMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                ...
                "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                "\tat the top of the " + TheHogMod.class.getSimpleName() + " java file.");
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(TheHogMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
