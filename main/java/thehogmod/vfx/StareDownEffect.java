...
public class StareDownEffect extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public StareDownEffect(float x, float y, boolean flipHorizontal) {
        if (img == null) {
    ...
    public void update() {
        if (!this.playedSfx) {
            ...
            this.playedSfx = true;
            CardCrawlGame.sound.playA("MONSTER_COLLECTOR_DEBUFF", 0.5F);
        }
