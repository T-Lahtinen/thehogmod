...
public class GiantCustomTextEffect extends AbstractGameEffect {
    ...
    public GiantCustomTextEffect(float x, float y, String customText) {
        this.targetString = customText;
        this.index = 0;
