...
public class FlyingDaggerWithColorEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float destY;
    ...
    public FlyingDaggerWithColorEffect(float x, float y, float fAngle, boolean shouldFlip, Color newColor) {
