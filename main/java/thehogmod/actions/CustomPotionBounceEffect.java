...
public class CustomPotionBounceEffect extends AbstractGameEffect {
    ...
    public CustomPotionBounceEffect(float srcX, float srcY, float destX, float destY, Color potionColor) {
        if (img == null) {
